...
using static FeastCreator.Server.Models.ChatEndpoint;

namespace FeastCreator.Server.Services;
...
public class OpenAIService : IOpenAIAPI
{
    ...
    public OpenAIService(IConfiguration configuration)
    {
        ...
        var apiKey = _configuration["OpenAI:OpenApiKey"] ?? Environment.GetEnvironmentVariable("OpenAiKey");
    ...
    public async Task<List<Idea>> CreateMealIdeasAsync(string mealTime, List<string> ingrediantList)
    {
        ...
        {
            ingredientPrompt = "I don't have any specific ingredients in mind, use any ingredients";
        }
        else
        {
        ...
        userPrompt = $"It's {mealTime}.{ingredientPrompt}. Give me 5 potential dishes I could prepare.";
    ...
    public async Task<RecipeImage?> CreateRecipeImageAsync(string recipeTitle)
    {
